...
static const char *TAG = "module_nb_iot";
...
extern connect_Simcom7090_t Simcom7090;//Simcom7090 la 1 bien theo kieu du lieu tu dinh nghia, trong do co chua buffer luu thong tin tra ve

char url[]      = "AT+SMCONF=\"URL\",\"demo.thingsboard.io\",1883";
char username[] = "AT+SMCONF=\"USERNAME\",\"VHT\"";
char clientid[] = "AT+SMCONF=\"CLIENTID\",\"VHT\"";
char password[] = "AT+SMCONF=\"PASSWORD\",\"123456\"";
